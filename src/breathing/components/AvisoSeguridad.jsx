...
//
// Aparece **dentro** de `/respiracion` y no como pantalla previa (RN-RE-NAV-35).
...
export default function AvisoSeguridad({ onDescartar }) {
  ...
  return (
    <aside className="flex flex-col gap-3 rounded-2xl border border-espacio p-4" role="note">
