// src/diario/__tests__/sugerenciasGratitud.test.js
...
import {
  ...
  silenciadas,
  textoEnfocado,
} from '@/diario/sugerenciasGratitud'

const CAMPO = 'src/components/diario/CampoGratitud.jsx'
const FILAS = 'src/components/diario/FilasDinamicas.jsx'
...
const MANANA = 'src/components/diario/manana/MomentoGratitud.jsx'
